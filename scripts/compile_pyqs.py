...
def main():
    ...
    if os.path.exists(base_json_path):
        ...
        with open(master_json_path, "w", encoding="utf-8") as f:
            json.dump(master_1380, f, indent=2)
        print(f"Saved master JSON ({len(master_1380)} questions): {master_json_path}")
        ...
        with open(all_ts_path, "w", encoding="utf-8") as f:
            f.write("// Autogenerated Master Question Bank (1,080 Core Syllabus + 300 High-Yield ICAR PG PYQs = 1,380 Total)\n")
            f.write("import { Question } from '../../types';\n")
            ...
            f.write("const BASE_1080_QUESTIONS: Question[] = " + json.dumps(base_1080, indent=2) + ";\n\n")
            f.write("export const ALL_HIGH_YIELD_QUESTIONS: Question[] = [\n")
            f.write("  ...BASE_1080_QUESTIONS,\n")
            f.write("  ...ALL_ICAR_PG_PYQ_QUESTIONS\n")
            f.write("];\n")
        print(f"Updated {all_ts_path} with total {len(master_1380)} questions!")
